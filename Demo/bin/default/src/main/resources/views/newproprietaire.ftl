...
<body xmlns="http://www.w3.org/1999/html">
    ...
    <h2>Ajouter un nouveau propriétaire pour le n°${numeroAppt} au ${adresseAppt}</h2>
    <form action="/saveProprietaire" onsubmit="return validateForm()" method="post">
        <p>
            <label for="numeroTel">Numéro de téléphone du propriétaire :</label><br>
